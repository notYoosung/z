...
if enable_built_in then
	...
	minetest.register_entity(modname .. ":vehicles_missile", {
		visual = "mesh",
		mesh = "missile.b3d",
	...
	minetest.register_craftitem(modname .. ":vehicles_missile_2_item", {
		description = S("Missile"),
		inventory_image = "vehicles_missile_inv.png"
	})

	minetest.register_craftitem(modname .. ":vehicles_bullet_item", {
		description = S("Bullet"),
		inventory_image = "vehicles_bullet_inv.png"
	})


	minetest.register_entity(modname .. ":vehicles_missile_2", {
		visual = "mesh",
		mesh = "missile.b3d",
		textures = {"vehicles_missile.png"},
		velocity = 15,
	...
	minetest.register_entity(modname .. ":vehicles_water", {
		visual = "sprite",
	...
	minetest.register_entity(modname .. ":vehicles_bullet", {
		visual = "mesh",
		mesh = "bullet.b3d",
	...
	minetest.register_entity(modname .. ":vehicles_tank", {
		visual = "mesh",
		mesh = "tank.b3d",
		...
		on_step = function(self, dtime)
			return vehicles.on_step(self, dtime, {
				...
				decell = 0.5,
				shoots = true,
				arrow = modname .. ":vehicles_missile_2",
				reload_time = 1,
				shoot_y = 2,
				moving_anim = {x=3, y=8},
				stand_anim = {x=1, y=1},
	...
	vehicles.register_spawner(modname .. ":vehicles_tank", S("Tank"), "vehicles_tank_inv.png")

	minetest.register_entity(modname .. ":vehicles_tank2", {
		visual = "mesh",
		mesh = "tank.b3d",
	...
	vehicles.register_spawner(modname .. ":vehicles_tank2", S("Desert Tank"), "vehicles_tank2_inv.png")

	minetest.register_entity(modname .. ":vehicles_turret", {
		visual = "mesh",
		mesh = "turret_gun.b3d",
	...
	vehicles.register_spawner(modname .. ":vehicles_turret", S("Gun turret"), "vehicles_turret_inv.png")

	minetest.register_entity(modname .. ":vehicles_assaultsuit", {
		visual = "mesh",
		...
		on_step = function(self, dtime)
			return vehicles.on_step(self, dtime, {
				...
				reload_time = 0.2,
				shoots2 = true,
				arrow2 = modname .. ":vehicles_missile_2",
				reload_time2 = 1,
	...
	vehicles.register_spawner(modname .. ":vehicles_assaultsuit", "Assault Suit", "vehicles_assaultsuit_inv.png")

	minetest.register_entity(modname .. ":vehicles_firetruck", {
		visual = "mesh",
		mesh = "firetruck.b3d",
	...
	vehicles.register_spawner(modname .. ":vehicles_firetruck", S("Fire truck"), "vehicles_firetruck_inv.png")

	minetest.register_entity(modname .. ":vehicles_tractor", {
		visual = "mesh",
		mesh = "tractor.b3d",
	...
	vehicles.register_spawner(modname .. ":vehicles_tractor", S("Tractor"), "vehicles_tractor_inv.png")

	minetest.register_entity(modname .. ":vehicles_geep", {
		visual = "mesh",
		mesh = "geep.b3d",
	...
	vehicles.register_spawner(modname .. ":vehicles_geep", S("Geep"), "vehicles_geep_inv.png")

	minetest.register_entity(modname .. ":vehicles_ambulance", {
		visual = "mesh",
		mesh = "ambulance.b3d",
	...
	vehicles.register_spawner(modname .. ":vehicles_ambulance", S("Ambulance"), "vehicles_ambulance_inv.png")

	minetest.register_entity(modname .. ":vehicles_ute", {
		visual = "mesh",
		mesh = "ute.b3d",
	...
	vehicles.register_spawner(modname .. ":vehicles_ute", S("Ute (dirty)"), "vehicles_ute_inv.png")

	minetest.register_entity(modname .. ":vehicles_ute2", {
		visual = "mesh",
		mesh = "ute.b3d",
	...
	vehicles.register_spawner(modname .. ":vehicles_ute2", S("Ute (clean)"), "vehicles_ute_inv.png")

	minetest.register_entity(modname .. ":vehicles_astonmaaton", {
		visual = "mesh",
	...
	vehicles.register_spawner(modname .. ":vehicles_astonmaaton", S("Aston Maaton (white)"), "vehicles_astonmaaton_inv.png")

	minetest.register_entity(modname .. ":vehicles_nizzan", {
		visual = "mesh",
		mesh = "nizzan.b3d",
	...
	vehicles.register_spawner(modname .. ":vehicles_nizzan", S("Nizzan (brown)"), "vehicles_nizzan_inv.png")

	minetest.register_entity(modname .. ":vehicles_nizzan2", {
		visual = "mesh",
		mesh = "nizzan.b3d",
	...
	vehicles.register_spawner(modname .. ":vehicles_nizzan2", S("Nizzan (green)"), "vehicles_nizzan_inv2.png")
	...
	minetest.register_entity(modname .. ":vehicles_lambogoni2", {
		visual = "mesh",
		mesh = "lambogoni.b3d",
	...
	vehicles.register_spawner(modname .. ":vehicles_lambogoni2", S("Lambogoni (yellow)"), "vehicles_lambogoni2_inv.png")

	minetest.register_entity(modname .. ":vehicles_masda", {
		visual = "mesh",
		mesh = "masda.b3d",
	...
	vehicles.register_spawner(modname .. ":vehicles_masda", S("Masda (pink)"), "vehicles_masda_inv.png")

	minetest.register_entity(modname .. ":vehicles_masda2", {
		visual = "mesh",
		mesh = "masda.b3d",
	...
	vehicles.register_spawner(modname .. ":vehicles_masda2", S("Masda (orange)"), "vehicles_masda_inv2.png")

	minetest.register_entity(modname .. ":vehicles_policecar", {
		visual = "mesh",
		mesh = "policecar.b3d",
	...
	vehicles.register_spawner(modname .. ":vehicles_policecar", S("Police Car (US)"), "vehicles_policecar_inv.png")

	minetest.register_entity(modname .. ":vehicles_musting", {
		visual = "mesh",
		mesh = "musting.b3d",
	...
	vehicles.register_spawner(modname .. ":vehicles_musting", S("Musting (purple)"), "vehicles_musting_inv2.png")

	minetest.register_entity(modname .. ":vehicles_musting2", {
		visual = "mesh",
		mesh = "musting.b3d",
	...
	vehicles.register_spawner(modname .. ":vehicles_musting2", S("Musting (white)"), "vehicles_musting_inv.png")

	minetest.register_entity(modname .. ":vehicles_fourd", {
		visual = "mesh",
		mesh = "fourd.b3d",
	...
	vehicles.register_spawner(modname .. ":vehicles_fourd", S("Fourd"), "vehicles_fourd_inv.png")

	minetest.register_entity(modname .. ":vehicles_fewawi", {
		visual = "mesh",
		mesh = "fewawi.b3d",
	...
	vehicles.register_spawner(modname .. ":vehicles_fewawi", S("Fewawi (red)"), "vehicles_fewawi_inv.png")

	minetest.register_entity(modname .. ":vehicles_fewawi2", {
		visual = "mesh",
		mesh = "fewawi.b3d",
	...
	vehicles.register_spawner(modname .. ":vehicles_fewawi2", S("Fewawi (blue)"), "vehicles_fewawi_inv2.png")

	minetest.register_entity(modname .. ":vehicles_pooshe", {
		visual = "mesh",
		mesh = "pooshe.b3d",
	...
	vehicles.register_spawner(modname .. ":vehicles_pooshe", S("Pooshe (red)"), "vehicles_pooshe_inv.png")

	minetest.register_entity(modname .. ":vehicles_pooshe2", {
		visual = "mesh",
		mesh = "pooshe.b3d",
	...
	vehicles.register_spawner(modname .. ":vehicles_pooshe2", S("Pooshe (yellow)"), "vehicles_pooshe_inv2.png")

	minetest.register_entity(modname .. ":vehicles_lightcycle", {
		visual = "mesh",
		mesh = "lightcycle.b3d",
		...
		on_step = function(self, dtime)
			return vehicles.on_step(self, dtime, {
				...
				boost_duration = 4,
				boost_effect = "vehicles_nitro.png",
				place_node = modname .. ":vehicles_light_barrier",
				place_trigger = true,
				death_node = modname .. ":vehicles_light_barrier2",
				handling = {initial=3, braking=2.2}
			})
		end,
	})

	vehicles.register_spawner(modname .. ":vehicles_lightcycle", S("Lightcycle"), "vehicles_lightcycle_inv.png")

	minetest.register_entity(modname .. ":vehicles_lightcycle2", {
		visual = "mesh",
		mesh = "lightcycle.b3d",
		...
		on_step = function(self, dtime)
			return vehicles.on_step(self, dtime, {
				...
				boost_duration = 4,
				boost_effect = "vehicles_nitro.png",
				place_node = modname .. ":vehicles_light_barrier2",
				place_trigger = true,
				death_node = modname .. ":vehicles_light_barrier",
				handling = {initial=3, braking=2.2}
			})
		end,
	})

	vehicles.register_spawner(modname .. ":vehicles_lightcycle2", S("Lightcycle 2"), "vehicles_lightcycle_inv2.png")

	minetest.register_entity(modname .. ":vehicles_boat", {
		visual = "mesh",
		mesh = "boat.b3d",
	...
	vehicles.register_spawner(modname .. ":vehicles_boat", S("Speedboat"), "vehicles_boat_inv.png", true)

	minetest.register_entity(modname .. ":vehicles_jet", {
		visual = "mesh",
		mesh = "jet.b3d",
	...
	vehicles.register_spawner(modname .. ":vehicles_jet", S("Jet"), "vehicles_jet_inv.png")

	minetest.register_entity(modname .. ":vehicles_apache", {
		visual = "mesh",
		mesh = "apache.b3d",
		...
		on_step = function(self, dtime)
			return vehicles.on_step(self, dtime, {
				...
				shoot_y = 3,
				shoot_y2 = 1.5,
				arrow2 = modname .. ":vehicles_bullet",
				reload_time2 = 0.1,
	...
	vehicles.register_spawner(modname .. ":vehicles_apache", S("Apache Helicopter"), "vehicles_helicopter2_inv.png")

	minetest.register_entity(modname .. ":vehicles_helicopter", {
		visual = "mesh",
		mesh = "helicopter.b3d",
	...
	vehicles.register_spawner(modname .. ":vehicles_helicopter", S("Helicopter"), "vehicles_helicopter_inv.png")

	minetest.register_entity(modname .. ":vehicles_plane", {
		visual = "mesh",
		mesh = "plane.b3d",
	...
	vehicles.register_spawner(modname .. ":vehicles_plane", S("Plane"), "vehicles_plane_inv.png")

	minetest.register_entity(modname .. ":vehicles_parachute", {
		visual = "mesh",
		mesh = "parachute.b3d",
	...
	minetest.register_tool(modname .. ":vehicles_backpack", {
		...
		on_use = function(item, placer, pointed_thing)
			...
			local obj = minetest.env:add_entity({x=playerpos.x+0+dir.x,y=playerpos.y+1+dir.y,z=playerpos.z+0+dir.z}, modname .. ":vehicles_parachute")
	...
	minetest.register_entity(modname .. ":vehicles_wing_glider", {
		visual = "mesh",
		mesh = "wings.b3d",
	...
	minetest.register_tool(modname .. ":vehicles_wings", {
		description = S("Wings"),
		inventory_image = "vehicles_backpack.png",
		wield_scale = {x = 1.5, y = 1.5, z = 1},
		tool_capabilities = {
		...
		on_use = function(item, placer, pointed_thing)
			...
			for k, obj2 in pairs(objs) do
				...
				if wing ~= nil and wing.name == modname .. ":vehicles_wing_glider" then
					wing.driver = nil
			...
			if wings_ready then
				local obj = minetest.env:add_entity({x=playerpos.x+0+dir.x,y=playerpos.y+1+dir.y,z=playerpos.z+0+dir.z}, modname .. ":vehicles_wing_glider")
				local entity = obj:get_luaentity()
	...
	minetest.register_tool(modname .. ":vehicles_rc", {
		...
		on_use = function(item, placer, pointed_thing)
			...
			if inv:contains_item("main", modname .. ":vehicles_missile_2_item") then
				local creative_mode = minetest.is_creative_enabled(placer:get_player_name())
				if not creative_mode then inv:remove_item("main", modname .. ":vehicles_missile_2_item") end
				local obj = minetest.env:add_entity({x=playerpos.x+0+dir.x,y=playerpos.y+1+dir.y,z=playerpos.z+0+dir.z}, modname .. ":vehicles_missile")
	...
	if minetest.get_modpath("default") and minetest.get_modpath("dye") or minetest.get_modpath("mcl_core") then
