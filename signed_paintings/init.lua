--https://github.com/Nettakrim/Signed-Paintings
--https://imgur.com/djoLu3Y
--https://codeberg.org/mineclonia/mineclonia/src/branch/main/mods/ITEMS/mcl_itemframes/init.lua
