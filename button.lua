...
local boxes_off = {
	type = "wallmounted",
	wall_side = { -8/16, -4/16, -2/16, -6/16, 4/16, 2/16 },
	wall_bottom = { -2/16, -8/16, -4/16, 2/16, -6/16, 4/16 },
	wall_top = { -2/16, 6/16, -4/16, 2/16, 8/16, 4/16 },
}
local boxes_on = {
	type = "wallmounted",
	wall_side = { -8/16, -4/16, -2/16, -7/16, 4/16, 2/16 },
	wall_bottom = { -2/16, -8/16, -4/16, 2/16, -7/16, 4/16 },
	wall_top = { -2/16, 7/16, -4/16, 2/16, 8/16, 4/16 },
}

-- Push the button
function z_mesecon.push_button(pos, node)
...
local buttonuse = "Use the button to push it."

function z_mesecon.register_button(basename, description, texture, recipeitem, sounds, plusgroups, button_timer, push_by_arrow, longdesc, button_sound)
	...
	local tt = "Provides redstone power when pushed"
	tt = tt .. "\n" .. "Push duration: @1s", string.format("%.1f", button_timer)
	if push_by_arrow then
		tt = tt .. "\n" .. "Pushable by arrow"
	end
	minetest.register_node(":mesecons_button:button_"..basename.."_off", {
		drawtype = "nodebox",
		tiles = {texture},
		wield_image = "z_button_wield_mask.png^"..texture.."^z_button_wield_mask.png^[makealpha:255,126,126",
		-- FIXME: Use proper 3D inventory image
		inventory_image = "z_button_wield_mask.png^"..texture.."^z_button_wield_mask.png^[makealpha:255,126,126",
		...
		on_rightclick = function(pos, node)
			z_mesecon.push_button(pos, node)
		end,
		sounds = sounds,
		mesecons = {receptor = {
